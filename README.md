# Домашнее задание к занятию "`Базы данных, их типы`" - `Толмачев Алексей`
...
Поддержка ACID: SQL системы обычно поддерживают ACID (атомарность, согласованность, изоляция, долговечность), что гарантирует сохранность и целостность данных. В то время как NoSQL системы могут не обеспечивать полную поддержку ACID.
